...
<script>
    ...
    $(function(){
        //判断当前是哪一个按钮，通过orderStatus进行判断。效果：显示当前按钮的数据show()，其他按钮数据进行hide().
        ...
        $("a.deleteOrderLink").click(function(){
            ...
            deleteOrder = false;
           //该确定/取消对话框（#deleteConfirmModal）在modal.jsp 中
           $("#deleteConfirmModal").modal("show");
         //   $("#loginModal").modal("show")
        });

        //当点击"确认" 按钮时，改变deleteOrder 状态
        ...
        //当deleteConfirmModal ，触发隐藏hidden 时，就有执行functio(e){......}
        $('#deleteConfirmModal').on('hidden.bs.modal', function (e) {
            //判断当前，deleteOrder 状态是否要删除
            if(deleteOrder){
                //删除功能在控制器中的地址
            ...
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                ...
                <c:forEach items="${o.orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemProductInfoPartTR" >
                        <td class="orderItemProductInfoPartTD"><img width="80" height="80" src="img/productSingle_middle/${oi.product.productFirstImage.id}.jpg"></td>
