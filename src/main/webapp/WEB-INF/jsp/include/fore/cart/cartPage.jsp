...
<script>
    ...
    $(function(){
        ...
        //1，通过直接修改在input里面，输入值，进行修改数量。
        //isNan(),判断参数是否是非数字，如果是非数字则返回true ，否则false
        ...
        $(".numberPlus").click(function(){
            ...
            //对数量进行操作修改
            num++;
            //如果数量大于了库存量（stock），则设置为最大（stock）
            if(num>stock)
                num = stock;
            //调用方法，进入controller中，修改数据中商品的数量
            syncPrice(pid,num,price);
        });
        ...
        $("button.createOrderButton").click(function(){
            ...
            //subString(1),生成一个新的字符串，从1 到末尾（下标从0开始）
            //这里是去除第一个"&"
            ...
            <c:forEach items="${ois }" var="oi">
                <tr oiid="${oi.id}" class="cartProductItemTR">
                    <td>
                        ...
                        <img class="cartProductImg"  src="img/productSingle_middle/${oi.product.productFirstImage.id}.jpg">
                    </td>
                    <td>
                    ...
                    <td>
                        <%--每次刷新订单项页面时，都会对商品的stock（库存），id等进行刷新--%>
